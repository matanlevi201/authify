...
import { BaseModalProps, ModalPropsMap, EModalTypes } from "@/types";
import { Button } from "@/components/ui/button";
import { use2fa } from "@/hooks/use-2fa";
import QRCode from "react-qr-code";

type ModalEnable2FAProps = ModalPropsMap[EModalTypes.MODAL_ENABLE_2FA] &
  BaseModalProps;

export const ModalEnable2FA = ({
  open,
  closeModal,
  qrCode,
}: ModalEnable2FAProps) => {
